...
export const menuItems = [ 
    new Menu (10, 'ADMIN_NAV.DASHBOARD', '/admin/dashboard', null, 'dashboard', null, false, 0),
    ...
    new Menu (25, 'ADMIN_NAV.SUBCATEGORIES', '/admin/products/subcategories', null, 'category', null, false, 20), 
    new Menu (26, 'ADMIN_NAV.PRODUCT_TYPE', '/admin/products/producttype', null, 'category', null, false, 20), 
    new Menu (27, 'ADMIN_NAV.MATERIAL', '/admin/products/material', null, 'category', null, false, 20), 
    new Menu (27, 'ADMIN_NAV.COLOR', '/admin/products/color', null, 'category', null, false, 20), 
    ...
    new Menu (25, 'ADMIN_NAV.STOCK', '/admin/stock', null, 'grid_on', null, false, 0), 
    new Menu (121, 'ADMIN_NAV.BANNERS', '/admin/banners', null, 'grid_on', null, false, 0), 
    new Menu (122, 'ADMIN_NAV.FEATURED', '/admin/featured', null, 'grid_on', null, false, 0), 
