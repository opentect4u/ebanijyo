...
export class AppService {
    ...
    public addProdToCookie:any=[];
    constructor(public http:HttpClient, public snackBar: MatSnackBar, public cookieService:CookieService) { }
    ...
    public addToCart(product:any){
        ...
        this.Data.cartList.forEach((pro:any)=>{
